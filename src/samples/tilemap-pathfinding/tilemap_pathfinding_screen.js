...
import { PathfinderGrid } from '../../lib/pathfinder/pathfinder_grid';
import { AStarGrid2D } from '../../lib/pathfinder/astar_grid';
// ---------------------------------------------------------------------------------------
...
class TilemapPathfindingScreen extends Screen {
  constructor() {
    ...
    this.pathfinder = new PathfinderGrid();
  }
  ...
  movePlayer(endX, endY) {
    ...
    let pathfinderGrid = new AStarGrid2D([collisionLayer.getColumns(), collisionLayer.getRows()], collisionLayer.getGrid());
