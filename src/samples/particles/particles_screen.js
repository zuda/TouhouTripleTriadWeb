...
class ParticlesScreen extends Screen {
  ...
  update(ts) {
    ...
    gfx3MeshRenderer.enableDirLight(1, [0, -1, 0.2]);
    gfx3MeshRenderer.setDirLightColor([0.8, 0.8, 0.8]);

    gfx3MeshRenderer.enablePointLight(0, 1, [Math.cos(this.colFac * 0.2) * 45.0, 18, Math.cos(this.colFac * 0.2) * 45.0]);
    gfx3MeshRenderer.setPointLightColor(0, [0.8, 0.8, 0.4]);

    gfx3MeshRenderer.enablePointLight(1, 1, [Math.sin(this.colFac * 0.2) * 45.0, 18, Math.sin(this.colFac * 0.2) * 45.0]);
