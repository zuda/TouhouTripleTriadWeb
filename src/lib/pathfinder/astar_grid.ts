abstract class AStarGrid<T extends vec2 | vec3> {
  grid: Array<number>;
  size: T;
...
class AStarGrid2D extends AStarGrid<vec2> {
...
class AStarGrid3D extends AStarGrid<vec3> {
...
export { AStarGrid, AStarGrid2D, AStarGrid3D };